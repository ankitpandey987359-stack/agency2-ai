...
const OurWork = () => {
    ...
    px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 dark:text-white/60'>
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl'>
                {
                    ...
                    transition-all cursor-pointer'>
                            ...
                            <h3 className='mt-3 mb-2 text-lg font-semibold drak:text-white'>{work.title}</h3>
                            <p className='text-sm opacity-60 w-5/6 dark:text-white/75'>{work.description}</p>
