...
const ContactUs = () => {
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "842f7c81-321c-4c31-9491-082ccdb10638");
        try {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            id='contact-us' className='flex flex-col items-center gap-7 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            ...
            <motion.form
                ...
                p-3 text-sm outline-none rounded-lg border border-gray-300 drak:border-gray-600' required />
                </div>
                <button type='submit' className='w-max flex gap-2 bg-primary text-white
            text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all'>Submit
