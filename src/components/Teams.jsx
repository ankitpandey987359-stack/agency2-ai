...
const Teams = () => {
  return (
    <motion.div
      ...
      <Title title='Meet the team' desc='A passionate team of digital experts dedicated to your brands seccess' />
      <div className='grid grid-cols-3 md:grid-cols-3 xl:grid-cols-4 gap-5'>
